...
EMAIL_HOST = config("EMAIL_HOST", cast=str, default="mail.inlinkai.com")
EMAIL_PORT = config("EMAIL_PORT", cast=str, default="587")  # Recommended
EMAIL_HOST_USER = config("EMAIL_HOST_USER", cast=str, default="anwar@inlinkai.com")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", cast=str, default="@Yourface21")
...
ADMIN_USER_EMAIL = config("ADMIN_USER_EMAIL", default="anwar@inlinkai.com")
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[Anipreneur] "
